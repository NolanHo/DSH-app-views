/**
 * tsdown build for dsh-app-views:
 ...
 *   window.__ModuleLoader__.load({ id: 'dsh-app-views', factory }), whose
 ...
 *   rejects any @deepseek-ai value import outside that table.
 */
...
/** Client-bundle purity gate: value imports outside the platform table are forbidden. */
const purityGate = {
  name: 'dsh-app-views-client-purity',
...
const client: UserConfig = {
  ...
  outputOptions: {
    ...
    banner: 'window.__ModuleLoader__.load({ id: "dsh-app-views", factory: (require) => {',
